...
# 1) load the trained csv with sentiment scores
...
# 2) use yfinance to get historical NASDAQ data for the last 2 years
...
# 3) combine the sentiment and technical data same as the scaler input
